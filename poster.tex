...
\begin{column}{\colwidth}
  ...
  \begin{block}{Normalizing Flows}
    ...
    \begin{equation}
      p(x) = \pi(z)\left|\det \frac{dz}{dx}\right| = \pi(f^{-1}(x))\left|\det \frac{\partial f^{-1}}{\partial x}\right|
    \end{equation}

    \begin{figure}
      \centering
      \includegraphics[width=0.9\columnwidth]{assets/flow_model.jpg}
      \caption{Using a Flow to generate data \(x'\). Image from~\cite{weng2018flow}}
    \end{figure}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.9\columnwidth]{assets/normalizing-flow.png}
