  ...
  \begin{block}{Results}
    ...
    \begin{figure}
      \begin{subfigure}{0.66\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{assets/hmc/dq_8x8_beta7_hmc_live.png}
    ...
    \begin{figure}
      \begin{subfigure}{0.66\columnwidth}
        \centering
          \includegraphics[width=\columnwidth]{assets/fthmc/beta7/dq_8x8_beta7_fthmc_live.png}
